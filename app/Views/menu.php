        ...
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="http://localhost:8080/home/beranda" aria-expanded="false">
                ...
                <?php if(session()->get('level')==1){?>
                    <li>
                        <a href="http://localhost:8080/home/masyarakat" aria-expanded="false">
                            <i class="icon-envelope menu-icon"></i> <span class="nav-text">Daftar akun masyarakat</span>
                        </a>
                    </li>
                <?php }?>
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="http://localhost:8080/home/polisi">List Polisi</a></li>
                            <li><a href="http://localhost:8080/home/admin">List Admin</a></li>
                        </ul>
                <?php if(session()->get('level')==1||session()->get('level')==2){?>
                    <li>
                        <a href="http://localhost:8080/home/data" aria-expanded="false">
                            <i class="mdi mdi-file-document-box font-18 align-middle mr-2"></i></i><span class="nav-text">Kumpulan Data Laporan</span>
                        </a>    
                    </li>   
                <?php }?>
